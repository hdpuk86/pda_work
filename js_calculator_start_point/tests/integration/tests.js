...
describe('calculator functionality', function() {
  ...
  it('should chain multiple operations', function(){
    ...
    element(by.css('#number8')).click();
    element(by.css('#operator_equals')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('48');
  });
  ...
  it('should work with decimals', function(){
    ...
    element(by.css('#number0')).click();
    element(by.css('#operator_equals')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('0.01');
  });
  ...
  it('should work with very large numbers', function(){
    ...
    element(by.css('#number1')).click();
    element(by.css('#operator_equals')).click();
    expect(running_total.getAttribute('value')).to.eventually.equal('999999999');
  })

  it('should display "ERROR" when you divide by zero', function(){
    running_total = element(by.css('#running_total'));
    element(by.css('#number5')).click();
    element(by.css('#operator_divide')).click();
    element(by.css('#number0')).click();
